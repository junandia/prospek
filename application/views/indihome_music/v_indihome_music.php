  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Indihome Music</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box-header">
              <table id="example1" class="table no-border" >
                 <tr>
                    ...
                    <td></td>
                   <td><button id="idIndihomeMusic" type="submit" class="btn bg-navy"  name="submit">Submit</button></td>
                 </tr>
                 </table>
                 <div>
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">INDIHOME MUSIC</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="exampleModalLabel">FORM UPLOAD DATA PELANGGAN MOVIN</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <?= form_open_multipart('c_indihome_music/import'); ?>
        <form method="post" action="<?= base_url() . 'c_indihome_music/import'; ?>">
