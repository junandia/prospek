  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Indi Server</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box-header">
              <table id="example1" class="table no-border" >
                 <tr>
                    ...
                    <td></td>
                   <td><button id="idIndiServer" type="submit" class="btn bg-navy"  name="submit">Submit</button></td>
                 </tr>
                 </table>
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Indi Server</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?= form_open_multipart('c_indi_server/import'); ?>
        <form method="post" action="<?= base_url() . 'c_indi_server/import'; ?>">
