  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Indihome Gamer</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
            ...
            <div class="box-header">
              <table id="example1" class="table no-border" >
                 <tr>
                    ...
                    <td></td>
                   <td><button id="idIndihomeGamer" type="submit" class="btn bg-navy"  name="submit">Submit</button></td>
                 </tr>
                 </table>
                 <div>
          ...
          <div class="box">
            <div class="box-header">
              ...
              <h3 class="box-title">INDIHOME GAMER</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?= form_open_multipart('c_indihome_gamer/import'); ?>
        <form method="post" action="<?= base_url() . 'c_indihome_gamer/import'; ?>">
