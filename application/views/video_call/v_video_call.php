            ...
            <div class="box-header">
              <table id="example1" class="table no-border" >
                 <tr>
                    ...
                    <td></td>
                   <td><button id="idVideoCall" type="submit" class="btn bg-navy"  name="submit">Submit</button></td>
                 </tr>
                 </table>
                 <div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="exampleModalLabel">FORM UPLOAD DATA PELANGGAN VIDEO CALL</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <?= form_open_multipart('c_video_call/import'); ?>
        <form method="post" action="<?= base_url() . 'c_video_call/import'; ?>">
